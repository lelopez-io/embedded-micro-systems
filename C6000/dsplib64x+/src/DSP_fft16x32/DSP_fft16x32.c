...
/*                           All Rights Reserved.                           */
/* ======================================================================== */
#pragma CODE_SECTION(DSP_fft16x32_i, ".text:intrinsic");
...
)
{
    ...
    double ydword0,    ydword1,    yl1dword0, yl1dword1;
    double yl2dword0,  yl2dword1,  yh2dword0, yh2dword1;
    ...
    while (stride > radix) {
        ...
        for (i = 0; i < (npoints >> 3); i++) {
            ...
            ydword0 = _itod(x_1o, x_0o);
            ydword1 = _itod(x_3o, x_2o);

            yh2dword0 = _itod(xh2_1o, xh2_0o);
            yh2dword1 = _itod(xh2_3o, xh2_2o);

            yl1dword0 = _itod(xl1_1o, xl1_0o);
            yl1dword1 = _itod(xl1_3o, xl1_2o);

            yl2dword0 = _itod(xl2_1o, xl2_0o);
            yl2dword1 = _itod(xl2_3o, xl2_2o);

            _amemd8(&xa2[0])  = ydword0;
            _amemd8(&xb2[0])  = ydword1;
            _amemd8(&xa2[h2]) = yh2dword0;
            _amemd8(&xb2[h2]) = yh2dword1;
            _amemd8(&xa2[l1]) = yl1dword0;
            _amemd8(&xb2[l1]) = yl1dword1;
            _amemd8(&xa2[l2]) = yl2dword0;
            _amemd8(&xb2[l2]) = yl2dword1;
        }
    } 
