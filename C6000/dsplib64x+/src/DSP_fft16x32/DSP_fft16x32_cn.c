...
/*                                                                          */
/*  NAME                                                                    */
/*      DSP_fft16x32_cn -- Radix-4 FFT with digit reversal                  */
/*                                                                          */
/*  USAGE                                                                   */
/*                                                                          */
...
/*                                                                          */
/*                       xl0  = x[2 * i0 + 0] - x[2 * i2 + 0];              */
/*                       xl1  = x[2 * i0 + 1] - x[2 * i2 + 1];              */
/*                       xl20 = x[2 * i1 + 0] - x[2 * i3 + 0];              */
/*                       xl21 = x[2 * i1 + 1] - x[2 * i3 + 1];              */
/*                                                                          */
/*                       xt1  = xl0 + xl21;                                 */
/*                       yt2  = xl1 + xl20;                                 */
...
/*                           All Rights Reserved.                           */
/* ======================================================================== */
#pragma CODE_SECTION(DSP_fft16x32_cn, ".text:ansi");
...
)
{
    ...
    while (stride > 4) {
        ...
        for (i = 0; i < (npoints >> 3); i ++) {
            ...
            /*---------------------------------------------------------*/
            x2[h2+0] = MPY16X32R(si10, yt1_0) + MPY16X32R(co10, xt1_0);
            ...
            x2[l1+0] = MPY16X32R(si20, yt0_0) + MPY16X32R(co20, xt0_0);
            ...
            x2[l2+0] = MPY16X32R(si30, yt2_0) + MPY16X32R(co30, xt2_0);
