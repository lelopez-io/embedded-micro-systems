...
)
{
    ...
    while (stride > radix) {
        ...
        for (i = 0; i < (npoints >> 3); i++) {
            ...
            /*-------------------------------------------------------------*/
            ydword0 = _itod(_hill(x_1o_yt0_0), _hill(x_0o_xt0_0));
            ydword1 = _itod(_hill(x_3o_yt0_1), _hill(x_2o_xt0_1));
            ...
            _amemd8(&x2[2])    = ydword1;

            _amemd8(&x2[h2])   = yh2dword0;
            _amemd8(&x2[h2+2]) = yh2dword1;

            _amemd8(&x2[l1])   = yl1dword0;
            _amemd8(&x2[l1+2]) = yl1dword1;
