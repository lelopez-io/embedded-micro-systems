/* ======================================================================= */
/* DSP_fir_r4_d.c -- FIR Filter (Radix 4)                                  */
...
clock_t time_c(int nh, int nr)
{
    ...
    t_start = clock();
    DSP_fir_r4_cn(ptr_x, ptr_h, ptr_r_c, nh, nr);
    t_stop = clock();
...
clock_t time_i(int nh, int nr)
{
    ...
    t_start = clock();
    DSP_fir_r4(ptr_x, ptr_h, ptr_r_i, nh, nr);
    t_stop = clock();
    return t_stop - t_start;
}

/* ======================================================================= */
/*  End of file:  DSP_fir_r4_d.c                                           */
/* ----------------------------------------------------------------------- */
/*            Copyright (c) 2007 Texas Instruments, Incorporated.          */
/*                           All Rights Reserved.                          */
/* ======================================================================= */
