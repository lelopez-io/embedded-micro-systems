...
/*                                                                          */
/* void fft16x16r_c (int n, short x[], short wn[],                          */
...
#pragma CODE_SECTION(DSP_fft16x16r_i, ".text:intrinsic");
...
)
{
    ...
    double ydword0, yh2_dword0, yl1_dword0, yl2_dword0;
    double x_32_x_10;
    ...
    while (stride > radix) {
        ...
        for (i = 0; i < n; i += 8) {
            ...
            /*---------------------------------------------------------*/
            ydword0    = _itod(x_3o_x_2o, x_1o_x_0o);
            yl1_dword0 = _itod(xl1_3_2, xl1_1_0);
            yh2_dword0 = _itod(xh2_3_2, xh2_1_0);
            yl2_dword0 = _itod(xl2_3_2, xl2_1_0);
            ...
            /*---------------------------------------------------------*/
            _amemd8(&x2[0])  = ydword0;
            _amemd8(&x2[h2]) = yl1_dword0;
            _amemd8(&x2[l1]) = yh2_dword0;
            _amemd8(&x2[l2]) = yl2_dword0;
        }
    }
