...
/*                           All Rights Reserved.                           */
/* ======================================================================== */
#pragma CODE_SECTION(DSP_ifft32x32_cn, ".text:ansi");
...
)
{
    ...
    while (stride > radix) {
        ...
        for (i = 0; i < npoints; i += 4) {
            ...
            /* pass for this stage.                                      */
            /*-----------------------------------------------------------*/
            x2[h2  ] = SMPY_32(co10, xt1_0) - SMPY_32(si10, yt1_0);
            x2[h2+1] = SMPY_32(co10, yt1_0) + SMPY_32(si10, xt1_0);
            x2[l1]   = SMPY_32(co20, xt0_0) - SMPY_32(si20, yt0_0);
            x2[l1+1] = SMPY_32(co20, yt0_0) + SMPY_32(si20, xt0_0);
            x2[l2]   = SMPY_32(co30, xt2_0) - SMPY_32(si30, yt2_0);
...
/* ======================================================================== */
/*  End of file: DSP_ifft32x32_cn.c                                         */
/* ------------------------------------------------------------------------ */
/*          Copyright (C) 2007 Texas Instruments, Incorporated.             */
/*                          All Rights Reserved.                            */
/* ======================================================================== */
