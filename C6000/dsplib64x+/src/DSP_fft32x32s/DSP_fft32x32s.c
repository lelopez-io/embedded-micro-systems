...
/*                           All Rights Reserved.                           */
/* ======================================================================== */
#pragma CODE_SECTION(DSP_fft32x32s_i, ".text:intrinsic");
...
)
{
    ...
    while (stride > radix) {
        ...
        for (i = 0; i < (npoints >> 3); i++) {
            ...
            /*-------------------------------------------------------------*/
            x_0o = _hill(xh0_0_xl0_0) + _hill(xh20_0_xl20_0);
            x_1o = _hill(xh1_0_xl1_0) + _hill(xh21_0_xl21_0);
            x_2o = _hill(xh0_1_xl0_1) + _hill(xh20_1_xl20_1);
            x_3o = _hill(xh1_1_xl1_1) + _hill(xh21_1_xl21_1);
            ...
            /*-------------------------------------------------------------*/
            _amemd8(&x2[0])    = _itod(x_1o, x_0o);
            _amemd8(&x2[2])    = _itod(x_3o, x_2o);
...
)
{
    ...
    long long xh0_0_xl0_0, xh1_0_xl1_0, xh0_1_xl0_1, xh1_1_xl1_1;
    long long n00_n20, n01_n21, n10_n30, n31_n11;
    long long n02_n22, n03_n23, n12_n32, n33_n13;
    ...
    for (i = 0; i < npoints; i += 8) {
        ...
        n10_n30 = _addsub(_loll(xh0_0_xl0_0), _loll(xh1_1_xl1_1));
        n31_n11 = _addsub(_loll(xh1_0_xl1_0), _loll(xh0_1_xl0_1));
        ...
        n12_n32 = _addsub(_loll(xh0_2_xl0_2), _loll(xh1_3_xl1_3));
        n33_n13 = _addsub(_loll(xh1_2_xl1_2), _loll(xh0_3_xl0_3));
        ...
        /*----------------------------------------------------------------*/
        _amemd8(&y0[2*h2 + 2]) = _itod(_hill(n03_n23), _hill(n02_n22));
        _amemd8(&y1[2*h2 + 2]) = _itod(_loll(n33_n13), _hill(n12_n32));
        _amemd8(&y2[2*h2 + 2]) = _itod(_loll(n03_n23), _loll(n02_n22));
        _amemd8(&y3[2*h2 + 2]) = _itod(_hill(n33_n13), _loll(n12_n32));
