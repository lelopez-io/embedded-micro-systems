...
/*                           All Rights Reserved.                           */
/* ======================================================================== */
#pragma CODE_SECTION(DSP_ifft16x16_i, ".text:intrinsic");
...
)
{
    ...
    /*-----------------------------------------------------------------*/
    /* The following code performs standard radix2.                    */
    ...
    /* puts that are 0, N/8, N/2, 3N/8 for a radix2 FFT.               */
    /*-----------------------------------------------------------------*/
    y0 = ptr_y;
    ...
    for (i = 0; i < npoints; i += 8) {
        ...
        /*----------------------------------------------------------------*/
        /* Read in the next eight inputs and perform radix2 decomposition */
        /*----------------------------------------------------------------*/
        x_8 = x2[0]; x_9 = x2[1];
        x_a = x2[2]; x_b = x2[3];
        x_c = x2[4]; x_d = x2[5];
...
)
{
    ...
    /* The input data is read "N/4" complex samples apart or "N/2"     */
    /* words apart using pointers "x0" and "x2". This produces out-    */
    /* puts that are 0, N/4, N/2, 3N/4 for a radix4 FFT.               */
    /*-----------------------------------------------------------------*/
    ...
    for (i = 0; i < npoints; i += 8) {
        ...
        /*----------------------------------------------------------------*/
        /* Read in the next eight inputs and perform radix4 decompisition */
        /*----------------------------------------------------------------*/
        x_8 = x2[0]; x_9 = x2[1];
        x_a = x2[2]; x_b = x2[3];
        x_c = x2[4]; x_d = x2[5];
