...
int main()
{
    ...
    */
    for (i = N/4; i <= N/4; i ++) {
        firlms2_testInit();
        fail += firlms2_test(h_c, h_cn, x, i*4, err, &time, &time_n);
    ...
    /*
        TEST 2: Verify the handling of the alignment of the input data.
    ...
    */
    ...
    /* -------------------------------------------------------------------- */
    if (!fail)
        printf("DSP_firlms2\tResult Successful\tnatC: %f\toptC: %f\n", timeItter_n, timeItter);
    else
