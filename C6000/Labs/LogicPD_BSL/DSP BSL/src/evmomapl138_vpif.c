//-----------------------------------------------------------------------------
// \file    evmomapl138_vpif.c
// \brief   implementation of a vpif driver for the OMAP-L138 EVM.
//
//-----------------------------------------------------------------------------
#include "types.h"
...
uint32_t VPIF_initReceive(video_connector_e in_conn)
{
   ...
   switch (in_conn)
   {
      ...
      case VIDEO_CONN_CAMERA:
         ...
         VPIF->CH0CTRL = DATAWIDTH_10BPP | (120 << INTLINE_SHIFT) | FIELDFRAME | CH01_INTRPROG | INTFRAME_TOP_ONLY | CAPMODE;
...
{
   EVMOMAPL138_pinmuxConfig(PINMUX_VPIF_TX_REG_0, PINMUX_VPIF_TX_MASK_0, PINMUX_VPIF_TX_VAL_0);
   EVMOMAPL138_pinmuxConfig(PINMUX_VPIF_TX_REG_1, PINMUX_VPIF_TX_MASK_1, PINMUX_VPIF_TX_VAL_1);
   EVMOMAPL138_pinmuxConfig(PINMUX_VPIF_TX_REG_2, PINMUX_VPIF_TX_MASK_2, PINMUX_VPIF_TX_VAL_2);
   EVMOMAPL138_pinmuxConfig(PINMUX_VPIF_TX_REG_3, PINMUX_VPIF_TX_MASK_3, PINMUX_VPIF_TX_VAL_3);
}
