...
override PKGDIR = xconfig_keystone_flash
...
package/%.xdc.inc package/%_xconfig_keystone_flash.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_keystone_flash" (because $@ is older than $(firstword $?))" ...
...
.PHONY: release,xconfig_keystone_flash
xconfig_keystone_flash.tar: package/package.bld.xml
xconfig_keystone_flash.tar: package/package.ext.xml
xconfig_keystone_flash.tar: package/package.rel.dot
xconfig_keystone_flash.tar: package/build.cfg
xconfig_keystone_flash.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_keystone_flash.tar.dep
endif
package/rel/xconfig_keystone_flash/xconfig_keystone_flash/package/package.rel.xml:

xconfig_keystone_flash.tar: package/rel/xconfig_keystone_flash.xdc.inc package/rel/xconfig_keystone_flash/xconfig_keystone_flash/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_keystone_flash.xdc.inc,package/rel/xconfig_keystone_flash.tar.dep)


release release,xconfig_keystone_flash: all xconfig_keystone_flash.tar
clean:: .clean
	-$(RM) xconfig_keystone_flash.tar
	-$(RM) package/rel/xconfig_keystone_flash.xdc.inc
	-$(RM) package/rel/xconfig_keystone_flash.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_keystone_flash.pjt
